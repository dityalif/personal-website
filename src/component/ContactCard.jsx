  ...
  return (
    <div>
          <a href={props.link} className='my-5 flex item-center'>
              <div key={props.id} className='flex w-96 justify-between bg-gradient-to-r from-[#00587A] to-[#0F3057] p-5 align-center items-center text-white mx-auto rounded-2xl shadow-2xl transition duration-200 hover:scale-105'>
